  ...
  useEffect(() => {
    ...
    const type = () => {
      ...
      if (isDeleting.current) {
        setTypedText(
          currentPhrase.substring(0, currentLetterIndex.current - 1),
        );
      ...
      <div className="container hero-container">
        <div className="hero-content">
          <h1 className="hero-title">
            Hi, I'm <span className="accent-text">Krish Mamtora</span>
          </h1>
          ...
          <p className="hero-description">
            I am a passionate full-stack web developer, eager to create
        ...
        <div className="hero-image-container">
          <div className="hero-image-wrapper" ref={profileRef}>
            <div className="profile-image">
              <img src="../../../krish_.png" alt="Krish Mamtora" />
            </div>
          </div>
        </div>
      </div>
