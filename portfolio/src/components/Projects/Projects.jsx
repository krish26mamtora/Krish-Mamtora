...
const projectsData = [
  {
    ...
    description:
      "A PHP-based real-time chatting and social media platform with WebSockets, user authentication, friend system, and live feed.",
    image: "/chat1.avif",
    tags: [
      "MySQL",
      "PHP",
  ...
  },
  {
    ...
    fullDescription:
      "EstateMate is an internal management system designed exclusively for real estate brokers. It provides tools to efficiently manage property listings, track rental timelines, schedule property visits, and match properties with buyer requirements. The platform also includes automated notifications for due rentals and visit reminders to streamline day-to-day operations. Developed using React for the frontend, it supports both MERN and Spring Boot-based backend versions, ensuring flexibility, reliability, and scalability for broker-centric workflows.",
  },
  {
    id: 7,
    title: "Custom HRMS & Employee Engagement Platform",
    description:
      "A role-based HRMS solution featuring travel management, job referrals, social collaboration, organizational insights, and office game scheduling.",
    image: "/hrms.jpeg",
    tags: ["React.js", ".NET", "Entity Framework Core", "SQL Server", "HRMS"],
    demoUrl: "#",
    repoUrl: "#",
    fullDescription:
      "A role-based HRMS platform with dedicated access for Employees, Team Leads, and HR Administrators. Features include travel plan management, job referral tracking, achievement and post sharing, automated birthday and work anniversary posts, and an interactive organizational chart. The platform also includes a game booking and slot arrangement module for office games such as pool, chess, and foosball, supporting team bookings, waiting queues with automatic queue promotion, and a cycle-based scheduling algorithm to ensure fair participation among employees.",
  },
];
  ...
  return (
    <section id="projects" className="projects" ref={projectsRef}>
      <div className="container">
        <h2
          className={`section-title ${isVisible ? "fade-in active" : "fade-in"}`}
        >
          My Projects
        </h2>

        <div
          className={`project-tags ${isVisible ? "fade-in active" : "fade-in"}`}
        >
          {allTags.map((tag) => (
            <button
              key={tag}
