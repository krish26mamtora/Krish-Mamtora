...
const skillsData = {
  technical: [
    ...
    { name: "Spring Boot", icon: <Package size={20} /> },
    { name: ".NET Core", icon: <Code size={20} /> },
  ...
  software: [
    ...
    { name: "Bitbucket", icon: <GitBranch size={20} /> },
    { name: "SSMS", icon: <Database size={20} /> },
  ],
  soft: [
  ...
  return (
    <section id="skills" className="skills" ref={skillsRef}>
      <div className="container">
        ...
        <div
          className={`skills-categories ${isVisible ? "fade-in active" : "fade-in"}`}
        >
          <button
